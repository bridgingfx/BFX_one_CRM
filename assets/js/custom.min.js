            ...
            if (jQuery(".navbar-nav").length > 0) {
                ...
                jQuery(document).on("scroll", function () {
                    ...
                    jQuery(".navbar-nav .scroll").each(function () {
                        var n = jQuery(this);
                        jQuery(n.attr("href"));
                        parseInt(jQuery(this.hash).offset().top, 10) - t <= e &&
            ...
            jQuery("#menu").length > 0 && $("#menu").metisMenu(),
                ...
                (function () {
                    if (jQuery(".dz-theme-mode").length > 0) {
                        ...
                        null != e &&
                            ...
                            setTimeout(function () {
                                "dark" ===
                                    jQuery("body").attr("data-theme-version") &&
                ...
                $(".navbar-nav .scroll").on("click", function (e) {
                    if (
                        ...
                        var t = this.hash,
                            n =
                                parseInt($(t).offset().top, 10) -
                                parseInt(
                                    $(".header .header-content").css("height"),
                                    10
                                );
                        $("html, body").animate(
                            { scrollTop: n },
                ...
                jQuery(".default-select").length > 0 &&
                    ...
                    jQuery(
                        ".default-select,.dataTables_wrapper select"
                    ).selectpicker()),
                jQuery(".counter").length > 0 &&
                    $(document).ready(function () {
                        $(".counter").counterUp({ delay: 10, time: 1e3 });
                    }),
                jQuery(".portofolio-social").length > 0 &&
                    document
                        .querySelectorAll(".portofolio-social li")
                        .forEach((e) => {
                            let t = 0,
                                n = 0,
                                a = 1,
                            ...
                            e.addEventListener("mousemove", (t) => {
                                ...
                                (function r() {
                                    (t = c(t, o, 0.1)),
                                        ...
                                        (e.style.transform = `translate(${t}px, ${n}px) scale(${a})`),
                ...
                (function () {
                    let e = new Date().getFullYear(),
                        t = document.getElementsByClassName("current-year");
                    for (const n of t) n.innerHTML = e;
                })();
        },
        load: function () {
            setTimeout(function () {
...
jQuery(document).ready(function () {
    $('[data-bs-toggle="popover"]').popover(), Jiade.init();
}),
    ...
    jQuery(".show-conpass").on("click", function () {
        jQuery(this).toggleClass("active"),
            "password" == jQuery("#dlab-conpassword").attr("type")
                ? jQuery("#dlab-conpassword").attr("type", "text")
                : "text" == jQuery("#dlab-conpassword").attr("type") &&
                  jQuery("#dlab-conpassword").attr("type", "password");
    });
