var dzChartlist = function(){
	...
	var chartRound = function(){
        ...
        // Render the chart in all .chartRound elements
        var chartRound = function() {
            const charts = document.querySelectorAll(".chartRound");
        
            charts.forEach((chartEl, index) => {
                // Create new chart instance for each element
                var chartBar = new ApexCharts(chartEl, options);
                chartBar.render();
            });
        }
