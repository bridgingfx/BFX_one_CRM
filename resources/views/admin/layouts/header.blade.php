                             ...
                             <div id="DZ_W_Notification1" class="widget-media dlab-scroll p-3" style="height:380px;">
                                 <ul class="timeline">
                                     <li>
                                         <div class="timeline-panel">
                                             <div class="me-2 search-p">
                                                 <svg class="one" width="25" height="25" viewBox="0 0 42 42"
                                     ...
                                     <li>
                                         <div class="timeline-panel">
                                             <div class="me-2 search-p">
                                                 <svg class="two" width="25" height="25" viewBox="0 0 56 56"
                                                     fill="none" xmlns="http://www.w3.org/2000/svg">
                                                     <path
                     ...
                     <li class="nav-item dropdown notification_dropdown">
                         <a class="nav-link  menu-wallet" href="javascript:void(0);">
                             <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                 ...
                                 <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                     <rect x="0" y="0" width="24" height="24" />
                                     <rect fill="#fff" x="4" y="4" width="7" height="7"
                                         rx="1.5" />
                                     <path
                     ...
                     <li>
                         <div class="dropdown header-profile2">
                             ...
                             <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <form id="logout-form" action="{{ route('pilot.logout') }}" method="POST" class="d-none">
										@csrf
									</form>
                                 <!-- Logout link -->
                                 ...
                                 {{-- <a href="{{ route('pilot.logout') }}" class="dropdown-item ai-icon">
