...
@section('content')
	...
	<!-- row -->
		...
		<!-- Row -->
			@include('admin.layouts.recentalerts')
			<div class="row">
				<div class="col-xl-12">
				
					@include('admin.layouts.dashboardadslider')
					@include('admin.layouts.dashboardsummarycard')
					@include('admin.layouts.dashboardmarketactivity')
