								...
								<form action="{{ route('register') }}" method="POST">
								 @csrf
									...
									<div class="mb-3">
									  ...
									  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="username" name="name" required />
									</div>
									<div class="mb-3">
									...
									<div class="mb-3 position-relative">
										...
										<input type="password" id="dlab-password" class="form-control" value="" name="password" required />
									...
									<div class="mb-3 position-relative">
										...
										<input type="password" id="dlab-conpassword" class="form-control" value="" name="password_confirmation" required />
										<span class="show-conpass eye">
											<i class="fa fa-eye-slash"></i>
											<i class="fa fa-eye"></i>
