        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                            ...
                            <div id="DZ_W_Notification1" class="widget-media dlab-scroll p-3" style="height:380px;">
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="me-2 search-p">
                                                <svg class="one" width="25" height="25" viewBox="0 0 42 42" fill="none"
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="me-2 search-p">
                                                <svg class="two" width="25" height="25" viewBox="0 0 56 56" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="me-2 search-p">
                                                <svg class="three" width="25" height="25" viewBox="0 0 42 42"
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="me-2 search-p">
                                                <svg class="four" width="25" height="25" viewBox="0 0 56 56" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M37.3334 22.167C37.3318 20.2347 35.7654 18.6688 33.8336 18.6667H23.3334V25.6667H33.8336C35.7654 25.6651 37.3318 24.0987 37.3334 22.167Z"
                                                        fill="#FFAB2D"></path>
                    ...
                    <li>@include('components.gtranslater')</li>
                    <li>
                        <div class="dropdown header-profile2">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="{{ route('logout') }}" class="dropdown-item ai-icon">
                                    ...
                                    <span class="ms-2 text-danger">{{ __('Log Out') }} </span>
                                </a>
                            </div>
                        </div>
                    </li>
    ...
    <div class="page-titles">
        <div class="sub-dz-head">
            <div class="d-flex align-items-center dz-head-title">
                <h2 class="text-white m-0">{{ @$pageTitle }}</h2>
            </div>
        ...
        @include('components.singleticker')
    </div>
</div>
<!--**********************************
