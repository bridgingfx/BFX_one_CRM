<div class="row mt-2">
    <div class="col-xl-3 col-sm-6 ">
        <div class="card pull-up card-box bg-primary">
            <div class="card-header border-0 pb-0">
                <div class="chart-num">
                    ...
                    <h2 class="font-w600 mb-0">${{ $walletBalance }}</h2>
                </div>
    ...
    <div class="col-xl-3 col-sm-6 ">
        <div class="card pull-up card-box bg-dark">
            <div class="card-header border-0 pb-0">
                <div class="chart-num">
                    <p>
                        <i class="fa-solid fa-sort-down me-2"></i>
                    ...
                    <h2 class="font-w600 mb-0">${{ $totalDeposit }}</h2>
                </div>
    ...
    <div class="col-xl-3 col-sm-6 ">
        <div class="card pull-up card-box bg-warning">
            <div class="card-header border-0 pb-0">
                <div class="chart-num">
                    <p>
                        <i class="fa-solid fa-sort-down me-2"></i>
                    ...
                    <h2 class="font-w600 mb-0">${{ $totalWithdrawal }}</h2>
                </div>
    ...
    <div class="col-xl-3 col-xxl-3 col-sm-6 ">
        <div class="card pull-up card-box bg-pink">
            <div class="card-header border-0 pb-0">
                <div class="chart-num">
                    <p>
                        <i class="fa-solid fa-sort-down me-2"></i>
