			...
			<div class="change-btn-1">
				<a href="javascript:void(0);" class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal1">
					<svg class="me-2 svg-main-icon" xmlns="http://www.w3.org/2000/svg"
						xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px" viewBox="0 0 24 24"
						version="1.1">
						<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							<rect x="0" y="0" width="24" height="24" />
							<path
			...
			<div class="card price-list-1 mb-0">
				...
				<div class="card-body p-3 py-0">
					<select class="form-control custom-image-select-2 image-select mt-3 mt-sm-0 style-1">
						<option data-thumbnail="{{ URL::asset('assets/images/svg/dash.svg') }}"
							data-content="<img src='assets/images/svg/dash.svg'/> Dash Coin">Dash Coin</option>
						<option data-thumbnail="{{ URL::asset('assets/images/svg/btc.svg') }}"
							data-content="<img src='assets/images/svg/btc.svg'/> Ripple">Ripple</option>
						<option data-thumbnail="{{ URL::asset('assets/images/svg/eth.svg') }}"
							data-content="<img src='assets/images/svg/eth.svg'/> Ethereum">Ethereum</option>
						<option data-thumbnail="{{ URL::asset('assets/images/svg/btc.svg') }}"
							data-content="<img src='assets/images/svg/btc.svg'/> Bitcoin">Bitcoin</option>
					</select>
			...
			<div class="card price-list style-2 border-top border-style">
				...
				<div class="card-body p-3 py-0">
					<select
						...
						<option data-thumbnail="{{ URL::asset('assets/images/svg/dash-pink.svg') }}"
							data-content="<img src='assets/images/svg/dash.svg'/> Dash Coin">Dash Coin</option>
						<option data-thumbnail="{{ URL::asset('assets/images/svg/btc.svg') }}"
							data-content="<img src='assets/images/svg/btc.svg'/> Ripple">Ripple</option>
						<option data-thumbnail="{{ URL::asset('assets/images/svg/eth.svg') }}"
