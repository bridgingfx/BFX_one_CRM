					...
					<div class="card">
						<div class="card-header border-0">
							<div class="d-flex flex-wrap">
								...
								<select class="default-select p2p-select width-100 mb-2" aria-label="Default" tabindex="0" name="status">
				...
				<div class="col-xl-12">
						<div class="card">
							<div class="card-header flex-wrap border-0">
								<h4 class="card-title mb-lg-0 mb-2"></h4>
							...
							<div class="card-body pt-0">
								<div class="tab-content" id="pills-tabContent">
									...
									<div class="tab-pane fade" id="pills-listing" role="tabpanel"
										...
										<div class="table-responsive dataTabletrade">
											<table id="example-history-3" class="table shadow-hover centered display  orderbookTable"
												style="min-width:845px">
												<thead>
													<tr>
														<th>Name</th>
