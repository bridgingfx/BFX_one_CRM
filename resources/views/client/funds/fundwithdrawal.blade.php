					...
					<div class="row">
						<div class="col-xl-12">
							<div class="card dz-card" id="custom-tab">
								...
								<div class="card-body">
									<div class="row">
										<h4 class="card-title">Choose Withdrawal Method</h4>
										<p class="card-text">Select your preferred method to withdraw funds securely</p>
										...
										<div class="basic-form">
											<form>
												<div class="row">
													...
													<div class="mb-3 col-md-4">
														<label for="formFile" class="form-label">Upload Account Proof</label>
